...
public class Main {
	...
	public static void main(String[] args) {
		...
		Student student3 = new Student("이준영", 28, "20190001", "체육교육과");
		/*student3.name = "이준영";
		student3.age = 28;
		student3.major = "체육교육학과";
		...
		System.out.println("학생3 - 최종고사 점수 : " + student3.getAverage(scores3));
	}
